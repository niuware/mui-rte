...
declare const AutocompleteStyles: () => Record<
  "container" | "item",
  | import("@mui/material/styles").CSSProperties
  | import("@mui/material/styles").CreateCSSProperties<{}>
  | import("@mui/material/styles").PropsFunc<
      {},
      import("@mui/material/styles").CreateCSSProperties<{}>
    >
>;
export declare const Autocomplete: React.ComponentType<
  Pick<
    React.PropsWithChildren<TAutocompleteProps>,
    "left" | "top" | "children" | "onClick" | "items" | "selectedIndex"
  > &
    import("@mui/material/styles").StyledComponentProps<"container" | "item">
>;
...
export declare type TToolbarControl =
  | "title"
  | "bold"
  | "italic"
  | "underline"
...
interface IMUIRichTextEditorProps
  extends TMUIRichTextEditorProps,
    WithStyles<typeof MUIRichTextEditorStyles> {}
...
declare const MUIRichTextEditorStyles: (
  ...
  | "inlineToolbar"
>;
declare const MUIRichTextEditor: import("react").JSXElementConstructor<
  Omit<
    IMUIRichTextEditorProps &
      import("react").RefAttributes<TMUIRichTextEditorRef>,
    "classes" | "theme"
  > &
    import("@mui/material/styles").StyledComponentProps<
      | "error"
      | "toolbar"
      | "root"
      | "container"
