...
const App = () => {
  ...
  return (
    <div>
      ...
      <button onClick={() => setSample(<CustomControls />)}>
        Custom Controls
      </button>
      <button onClick={() => setSample(<Decorators />)}>Decorators</button>
      <button onClick={() => setSample(<InlineToolbar />)}>
        Inline Toolbar
      </button>
      <button onClick={() => setSample(<CustomInlineToolbar />)}>
        Custom Inline Toolbar
      </button>
      <button onClick={() => setSample(<AtomicCustomBlock />)}>
        Atomic Custom Block
      </button>
      <button onClick={() => setSample(<AsyncAtomicCustomBlock />)}>
        Async Atomic Custom Block
      </button>
      <button onClick={() => setSample(<AsyncImageUpload />)}>
        Async image upload
      </button>
      ...
      <button onClick={() => setSample(<AutocompleteAtomic />)}>
        Autocomplete Atomic
      </button>
